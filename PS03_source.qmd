...
-   The last city listed in `txhousing` is Wichita Falls.
:::
...
-   Total active listings for the housing market in Texas.
:::
...
head(dallas_sub)
# The previous code doesn't give the requested answer because R views the code
# as a request for 2012 data in Dallas, followed by data from all cities in
# 2013.
```
:::
...
-   This code chunk does all the previous problems 4-7 in one pipeline.
:::
...
-   San Marcos, with 85 houses listed.
:::
...
-   The most houses sold was in August, with 7112 sold.
:::
